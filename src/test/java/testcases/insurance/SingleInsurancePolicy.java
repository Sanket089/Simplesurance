...
public class SingleInsurancePolicy {
...
//		sip.CountryOptionddPath().click();
	...
	private void sepaDirectDebit(WebDriver driver) {
...
//		sip.CountryOptionddPath().click();
		...
		sip.SEPA().click();
		sip.Continue_to_Payment().click();
		sip.SEPAAccountName().sendKeys(FIRST_NAME);
		sip.SEPAEmail().sendKeys(EMAIL);
		sip.SEPAIBANnumber();

//		sip.SEPAIBANCheckbox().click();
//		sip.SEPAIBANproceedpayment().click();
		sip.SEPAIBANCheckbox();
		sip.SEPAIBANproceedpayment();
	}
